# Python Tkinter GUI based "relation CALCULATOR"
...
# Function to calculate relation percentage
...
# Heading on Top
heading = Label(root, text='Relation Calculator - How much is he/she into you')
heading.pack()
...
# Text on result slot
result = Label(root, text='relation Percentage between both of You:')
result.pack()
